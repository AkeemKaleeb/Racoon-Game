...
public class PlayerData : ScriptableObject
{
    ...
    public float maxJumpSpeed; //Maximum upwards speed of the player when performing comsecutive jumps.
    ...
    public float defaultLerpAmount = 1f; //The default lerp value for the Run(float) function in PLayController2D .
    [Space(5)]
    ...
    public int extraJumpAmount; //The number of jumps the player can make while not grounded.
    [Min(.01f)] public float extraJumpMult; //The number of jumps the player can make while not grounded.
    ...
    public Vector2 neutralWallJumpForce; //The actual force (this time set by us) applied to the player when wall jumping.
    [Space(5)]
